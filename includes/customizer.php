...
$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'mvdk_facebook', array(
...
$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'mvdk_twitter', array(
...
$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'mvdk_500px', array(
...
$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'mvdk_linkedin', array(
...
$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'mvdk_flickr', array(
