<?php
/**
 * The template for displaying all single gastartikelen
 *
 * @package mvdk-theme
 * @since mvdk-theme v2
 */
...
<?php
// echo get_the_term_list( get_the_ID(), 'gastartikel-type', '<div class="cpt-links">', _x( ', ', 'Used between list items, there is a space after the comma.', 'harmonic' ), '</div>' );
