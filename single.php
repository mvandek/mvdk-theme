...
<article id="post-<?php the_ID(); ?>" itemprop="blogPost" itemscope itemtype="http://schema.org/BlogPosting">
...
if( $get_post_tag_terms_from_post && ! is_wp_error( $get_post_tag_terms_from_post ) ) {
...
if( $get_locatie_terms_from_post && ! is_wp_error( $get_locatie_terms_from_post ) ) {
